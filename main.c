...
extern void fotadevice_download_prepare(void);
...
int main(int argc, char **argv)
{
    ...
    char host[HTTP_HOST_LEN] = "10.38.182.179";
    unsigned short port = HTTP_DEF_PORT;
    unsigned long addr;
    char file_name[HTTP_HOST_LEN] = "1.php";
    char file_nameforsave[HTTP_HOST_LEN] = "web.txt";
    FILE *file_web;
